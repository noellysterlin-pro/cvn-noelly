...
// Palette & polices partagées avec tes slides
const PALETTE = {
  primary: "#7030A0",
  accent: "#F5E663",
};
...
// Remplace par ta photo locale (dans /public)
    ...
    <header className="sticky top-0 z-50 backdrop-blur supports-[backdrop-filter]:bg-black/10">
      <div className="bg-[linear-gradient(180deg,#111827_0%,#221f2b_100%)] text-white border-b border-white/10">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          {/* À gauche : avatar + intitulé */}
          <div className="flex items-center gap-3">
            <div
              className="h-9 w-9 rounded-full overflow-hidden ring-2"
              style={{ boxShadow: `0 0 0 2px ${PALETTE.accent}66` }}
            >
              <img
                src={PORTRAIT_URL}
            ...
            <div>
              <p
                ...
                className="font-semibold leading-tight tracking-wide uppercase"
              >
                Noelly Sterlin
              </p>
              <p className="text-xs" style={{ color: PALETTE.accent }}>
                Science × Stratégie business & développement (Santé, Biotech,
                Nutrition)
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4 ml-6">
            <div className="flex items-center gap-4 text-2xl">
              <a
                ...
                aria-label="Profil LinkedIn de Noelly Sterlin"
              >
                <Linkedin />
              </a>
              <a
                href="mailto:noelly.sterlin.pro@gmail.com"
                className="text-white/90 hover:text-white transition duration-300"
                aria-label="Envoyer un email à Noelly Sterlin"
              >
                <Mail />
              </a>
            </div>
